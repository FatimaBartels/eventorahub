...
<div class="flex justify-between items-center mb-6">
    <div>
        ...
        <h1 class="text-2xl font-medium">Create category</h1>
    </div>
...
<div class="bg-white border border-gray-100 rounded-xl p-6 max-w-lg">
    <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-4">
        @csrf
        <x-admin.form-field label="Category name" name="name" :value="old('name')" placeholder="e.g. Music" />
        <x-admin.form-field label="Slug" name="slug" :value="old('slug')" placeholder="e.g. music" />
