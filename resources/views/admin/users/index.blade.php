    ...
    <table class="min-w-full text-sm border-collapse">
        <thead>
            <tr class="border-b border-gray-100">
                ...
                <th class="px-4 py-3 text-left text-[11px] uppercase tracking-wide font-medium text-gray-400">Email</th>
                <th class="px-4 py-3 text-left text-[11px] uppercase tracking-wide font-medium text-gray-400">Role</th>
                <th class="px-4 py-3 text-left text-[11px] uppercase tracking-wide font-medium text-gray-400">Status</th>
                <th class="px-4 py-3 text-left text-[11px] uppercase tracking-wide font-medium text-gray-400">Registered</th>
                ...
                <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-4 py-3">
                        <div class="flex items-center gap-3">
                            <div class="w-8 h-8 rounded-full bg-blue-50 text-blue-600 flex items-center justify-center text-[11px] font-medium flex-shrink-0">
                    ...
                    <td class="px-4 py-3">
                        @if($user->role === 'admin')
                            <span class="text-[11px] font-medium px-2 py-0.5 rounded bg-red-50 text-red-600">Admin</span>
                        @else
                            <span class="text-[11px] font-medium px-2 py-0.5 rounded bg-gray-100 text-gray-500">User</span>
                        @endif
                    </td>
