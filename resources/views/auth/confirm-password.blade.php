...
<div class="mb-6">
    <h1 class="text-xl font-medium text-gray-900">Confirm your password</h1>
    <p class="text-sm text-gray-400 mt-1">This is a secure area. Please confirm your password before continuing.</p>
</div>
